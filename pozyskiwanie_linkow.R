...
# w bazie na dzień 16.04 jest 318,485 filmów
# wyświetlane są po 50 na stronie
# ściągamy pierwsze 100 000, bo linki są analogiczne
# potem do linków dodawane są tokeny, który uniemożliwiają parsowanie strony
...
tabela <- c(tab, tab2, tab3)
tabela <- tabela[!duplicated(tabela)]
